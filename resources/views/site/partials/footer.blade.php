...
<div class="footer-column three columns" id="footer-widget-4">
    <div id="text-11" class="widget widget_text gdlr-item gdlr-widget">
        ...
        <div class="clear"></div>
        <p><i class="gdlr-icon fa fa-phone" style="color: #fff; font-size: 16px; "></i> <a href="tel:5567913598">+52 55-6791-3598</a></p>
    ...
    <div class="copyright-social-wrapper">
        <div class="social-icon">
            <a href="#" target="_blank">
                <img width="32" height="32" src="/images/social/facebook.png" alt="Facebook" />
            </a>
        </div>
        <div class="clear"></div>
    </div>
    <div class="copyright-left">
        <a href="#" style="margin-right: 10px;">Inicio</a>|<a href="/catalogo/?name=teosyal" style="margin-right: 10px; margin-left: 10px;">Teosyal</a> | <a href="/catalogo/?name=inno" style="margin-right: 10px; margin-left: 10px;">Inno</a> | <a href="/contacto" style="margin-left: 10px;">Contacto</a> </div>
